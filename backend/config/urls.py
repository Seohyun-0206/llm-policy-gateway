...
from apps.catalog.views import (
    ...
    RoutingRuleListView,
    ServiceFeatureDetailView,
    ServiceFeatureListView,
    ThresholdRuleDetailView,
    ThresholdRuleListView,
    TierRecommendationView,
...
urlpatterns = [
    ...
    path("api/service-features/", ServiceFeatureListView.as_view(), name="service-features"),
    path("api/service-features/<int:pk>/", ServiceFeatureDetailView.as_view(), name="service-feature-detail"),
    path("api/tier-recommendations/", TierRecommendationView.as_view(), name="tier-recommendations"),
    path("api/policy-draft/generate/", PolicyDraftGenerateView.as_view(), name="policy-draft-generate"),
    path("api/policy-drafts/", PolicyDraftListView.as_view(), name="policy-drafts"),
    path("api/policy-drafts/<int:pk>/", PolicyDraftDetailView.as_view(), name="policy-draft-detail"),
    path("api/policy-drafts/<int:pk>/save/", PolicyDraftSaveView.as_view(), name="policy-draft-save"),
]
